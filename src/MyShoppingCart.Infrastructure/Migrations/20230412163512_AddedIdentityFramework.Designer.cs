...
namespace MyShoppingCart.Infrastructure.Migrations
{
    ...
    [Migration("20230412163512_AddedIdentityFramework")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyShoppingCart.Domain.Entities.AppRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MyShoppingCart.Domain.Entities.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MyShoppingCart.Domain.Entities.SecurityClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("756775dd-f1b3-4719-b9a9-8e5ead396933"),
                        ...
                        new
                        {
                            Id = new Guid("20302cca-2fc4-494e-bfad-b701a7b156f9"),
                            CustomerId = new Guid("4a5eb696-7c8f-47d4-974b-c1da72cec2c5"),
                        ...
                        new
                        {
                            Id = new Guid("d2619c52-11b0-4c2b-8f03-f158b3a65c2a"),
                        ...
                        new
                        {
                            Id = new Guid("c618626c-5f06-4059-893e-3ecece30dc28"),
                            CustomerId = new Guid("79f42c77-83e5-403b-9ec1-6a3ff285c5ac"),
                            Type = "http://schemas.microsoft.com/ws/2008/06/identity/claims/role",
                            Value = "Admin"
                        });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("MyShoppingCart.Domain.Entities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("MyShoppingCart.Domain.Entities.AppUser", null)
                        .WithMany()
