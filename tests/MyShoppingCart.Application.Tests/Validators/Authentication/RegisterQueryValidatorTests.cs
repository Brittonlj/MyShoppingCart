...
public sealed class RegisterQueryValidatorTests
{
    private readonly IValidator<RegisterQuery> _validator = new RegisterQueryValidator();
    ...
    {
        //Arrange
        var query = QueryProvider.GetRegisterQuery();
    ...
    {
        //Arrange
        var query = QueryProvider.GetRegisterQuery() with { FirstName = string.Empty };
        ...
        results.AssertValidationErrors(
            nameof(RegisterQuery.FirstName),
    ...
    {
        //Arrange
        var query = QueryProvider.GetRegisterQuery() with { FirstName = LongStrings.LONG_STRING_51 };
    ...
    {
        //Arrange
        var query = QueryProvider.GetRegisterQuery() with { LastName = string.Empty };
    ...
    {
        //Arrange
        var query = QueryProvider.GetRegisterQuery() with { LastName = LongStrings.LONG_STRING_51 };
    ...
    {
        //Arrange
        var query = QueryProvider.GetRegisterQuery() with { Email = string.Empty };
    ...
    {
        //Arrange
        var query = QueryProvider.GetRegisterQuery() with { Email = LongStrings.LONG_STRING_51 };
    ...
    {
        //Arrange
        var query = QueryProvider.GetRegisterQuery() with { Email = "test" };
    ...
    {
        //Arrange
        var query = QueryProvider.GetRegisterQuery() with { BillingAddress = null };
        ...
        //Assert
        results.AssertValidationErrors(
            nameof(RegisterQuery.BillingAddress),
    ...
    {
        //Arrange
        var query = QueryProvider.GetRegisterQuery() with
        {
    ...
    {
        //Arrange
        var query = QueryProvider.GetRegisterQuery() with { ShippingAddress = null };
        ...
        //Assert
        results.AssertValidationErrors(
            nameof(RegisterQuery.ShippingAddress),
